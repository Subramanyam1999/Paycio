...
public class PayContactAddress extends BaseTest {
    ...
    @Test()
    public void Pay_contact_Address_Scenario() throws InterruptedException {
        ...
        // operationsbutton.grabResultsAboveEditText();
       // operationsbutton.clickFirstInviteButtonForContact("Akas");
      //  operationsbutton.clickFirstInviteButtonForContact("0x6EEc5c5786BE10145646D1550C51aa24Cf3CB80F");
        operationsbutton.clickFirstInviteButton();
        operationsbutton.clickOnSharingLink();
        Thread.sleep(2000);
