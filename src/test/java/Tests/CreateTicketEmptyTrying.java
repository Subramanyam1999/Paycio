...
public class CreateTicketEmptyTrying extends BaseTest {
    ...
    @Test(priority = 1)
    public void CreateTicket_Empty_Num_Field_Scenario() throws InterruptedException {
...
//        }
        ...
        try {
            ...
            createticket.mobileNumberEmptyFiled();
