...
public class CreateTicketNegative extends BaseTest {
    ...
    @Test(priority = 3)
    public void CreateTicket_Eleven_Numbers_entered_Scenario() throws InterruptedException {
        ...
        try {
            enter_mobile_number_eleven_digits();
...
//
//@Test(priority = 2)
//public void Create_Ticket_Negative_scenario() throws InterruptedException, MalformedURLException {
//
//    ConfigureAppium();
//    // Step 1: Click the 'Allow' button
//    try {
...
//    // Step 4: Enter mobile number
//    try {
//        enter_mobile_number_nine_digits();
//
//        stepsPassed++;
//        System.out.println("Step 4: Entered mobile number - Passed");
//    } catch (Exception e) {
